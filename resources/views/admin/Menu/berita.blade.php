            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('berita.index') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a href="#" class="dropdown-item" onclick="getpop({{$item->id_berita}})"><i class="bi bi-search"></i> View</a>
                                                    
                                                    
                                                    <a href="{{ route('berita.edit',$item->id_berita) }}" class="dropdown-item"><i class="bi bi-pencil-square"></i> Edit</a>
