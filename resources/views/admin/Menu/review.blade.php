                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('Produk.index') }}" method="post" target="_self"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama" id=""
                                                        class="form-control" placeholder="Edit Nama Pengunjung">
                                                </div>
                                            </div>

                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="wysiwyg" class="form-label">Review Pengunjung</label>
                                                    <textarea class="ckeditor form-control" id="wysiwyg" rows="3" name="review_pengunjung"></textarea>
                                                </div>
                                            </div>

                                            <button type="submit" class="btn btn-primary">Tampilkan Komentar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" style="overflow-y: scroll; max-height: 100%">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="">
                        <iframe style="border:0; width: 100%; height: 270px;" id="map" src=""
